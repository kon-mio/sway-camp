<template>
  <div class="abyss-avatar" :style="{ width: width + 'px', height: height + 'px' }">
    <img class="abyss-avatar-img abyss-avatar-face abyss-avatar-img-radius" :src="avatar" />
    <div class="abyss-avatar-pendent-dom">
      <img class="abyss-avatar-img" :src="pendent" />
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  props: {
    ...
    avatar: {
      type: String,
      default: "http://file.konmio.com/image/6dd64ae8db1143758587df1fdabe25a4.webp"
    },
    pendent: {
      type: String,
      default: "http://file.konmio.com/image/9812ffc1edd542b9ae7401664612b5d0.webp"
    },
    fromUserId: {
      type: Number,
      default: 0
